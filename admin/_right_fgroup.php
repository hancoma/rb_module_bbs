...
<div class="well well-lg">
	<div class="form-group">
			...
			<div class="col-sm-10">
				 <h3><span class="label label-default">목록접근</label></h3>
			</div>				
	</div>
   <div class="form-group">
			<label class="col-sm-2 control-label">허용등급</label>
			<div class="col-sm-10">
				<select name="perm_l_list" class="form-control">
	...
	<div class="form-group">
			...
			<div class="col-sm-10">
			   <select name="_perm_g_list" class="form-control" multiple size="5">
...
<div class="well well-lg">
	<div class="form-group">
			<label class="col-sm-2 control-label"></label>
			<div class="col-sm-10">
				 <h3><span class="label label-default">본문열람</label></h3>
			</div>				
	</div>
   <div class="form-group">
			<label class="col-sm-2 control-label">허용등급</label>
...
<div class="well well-lg">
	 <div class="form-group">
			<label class="col-sm-2 control-label"></label>
			<div class="col-sm-10">
				 <h3><span class="label label-default">글쓰기</label></h3>
			 </div>				
	</div>
   <div class="form-group">
			<label class="col-sm-2 control-label">허용등급</label>
...
<div class="well well-lg">
	<div class="form-group">
			<label class="col-sm-2 control-label"></label>
			<div class="col-sm-10">
				 <h3><span class="label label-default">다운로드</span></h3>
			</div>				
	</div>
   <div class="form-group">
			<label class="col-sm-2 control-label">허용등급</label>
			<div class="col-sm-10">
				<select name="perm_l_down" class="form-control">
					<option value="0">&nbsp;+ 전체허용</option>
					<option value="0">--------------------------------</option>
					<?php $_LEVEL=getDbArray($table['s_mbrlevel'],'','*','uid','asc',0,1)?>
					<?php while($_L=db_fetch_array($_LEVEL)):?>
	...
	<div class="form-group">
			<label class="col-sm-2 control-label">차단그룹</label>
			<div class="col-sm-10">
			   <select name="_perm_g_down" class="form-control" multiple size="5">
