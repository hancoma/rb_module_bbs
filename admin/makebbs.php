...
<div class="row">
   ...
   <div id="tab-content-view" class="col-md-8 col-lg-9">
       ...
       <div class="form-group">
		...
		<div class="form-group">
		  	  <label class="col-sm-2 control-label">댓글 테마 </label> 
		     <div class="col-sm-10">
		     	   <div class="col-sm-5 nopadding">
	 			  		 <select name="c_skin" class="form-control">
					...
					<div class="col-sm-5">
						 <span>
					      <label>
						     <input type="checkbox" name="c_hidden" value="1"<?php if($d['bbs']['c_hidden']):?> checked<?php endif?>>
						     <i></i>사용안함
					      </label>
				       </span>
				       <span style="padding-left:15px;">
					      <label>
						     <input type="checkbox" name="c_open" value="1"<?php if($d['bbs']['c_open']):?> checked<?php endif?>>
						     <i></i>자동펼침
					      </label>
				       </span>
					</div>						
		...
		<div class="form-group">
		  	  <label class="col-sm-2 control-label text-muted">(모바일 접속) </label> 
		     <div class="col-sm-10">
 			  		<select name="c_mskin" class="form-control">
