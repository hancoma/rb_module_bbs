...
<div class="row">
	 <div class="col-sm-1 hidden-xs pull-left">
	 	   <?php if($g['member']['photo']):?>
	 	       <img src="<?php echo $g['url_root']?>/_var/simbol/<?php echo $g['member']['photo']?>" alt="회원 등록 아이콘" class="mbr-simbol" />
         <?php else:?>
              <img src="<?php echo $g['img_module_skin']?>/mbrimg_blank.png" alt="회원 기본 아이콘" class="mbr-simbol" />
	 	  <?php endif?>
	 </div>
	 <div class="col-sm-11">
	 	  <h2 class="view-title">
	 	  ...
	 	  <div class="col-sm-7 text-muted nopd-left">
	 	  	  ...
	 	  	  <span class="title-ele">조회 : <?php echo $R['hit']?></span>
	 	  	   <?php if($d['theme']['show_score1']):?><span class="title-ele">공감 : <span class="num"><?php echo $R['score1']?></span></span> <?php endif?>
				<?php if($d['theme']['show_score2']):?><span class="title-ele">비공감 : <span class="num"><?php echo $R['score2']?></span></span> <?php endif?>
			 	  </div>
